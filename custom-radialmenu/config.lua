		...
		items = {
			{
				...
				icon = "address-book",
				type = "client",
				event = "qb-phone:client:GiveContactDetails", -- CHANGE THIS TO YOUR PHONES GIVE CONTACT DETAILS
				shouldClose = true
			},
			{
				id = "getintrunk",
				...
				items = {
					{
                				...
                				icon = 'cannabis',
                				type = 'client',
						event = 'md-drugs:client:cornerselling', -- CHANGE THIS TO YOUR DRUGS SELLING EVENT
						shouldClose = true
					},
					{
						id = "playerinvehicle",
...
Config.JobInteractions = {
	...
	["police"] = {
		...
		},
		{
			...
			shouldClose = true,
        		onSelect = function()
            			TriggerEvent('police:server:policeAlert') -- CHANGE THIS YOUR POLICEJOB PANIC EVENT
        		end
		},
			...
			items = {
				{
					...
					icon = 'radio',
					type = 'client',
					event = 'qb-radio:client:leaveradio',
					shouldClose = true
				},
				{
					id = 'joinradio1',
